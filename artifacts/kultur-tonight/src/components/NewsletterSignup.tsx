...
const copy = {
  en: {
    ...
    weeklyGuideBody:   "Get Geneva's best cultural events in your inbox every week.",
  ...
  fr: {
    ...
    weeklyGuideBody:   "Recevez chaque semaine les meilleures sorties culturelles à Genève.",
