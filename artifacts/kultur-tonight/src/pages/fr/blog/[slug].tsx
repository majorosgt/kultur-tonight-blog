...
export default function FrBlogDetailPage() {
  ...
  const relatedGuides = guidesFr.filter((g) => g.slug !== guide.slug).slice(0, 3);
      ...
      <main className="pt-24">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap gap-6 mb-10 text-sm text-muted-foreground font-sans">
                <span className="flex items-center gap-2">
                  ...
                  {new Date(guide.publishedAt).toLocaleDateString("fr-CH", { year: "numeric", month: "long", day: "numeric" })}
                </span>
                <span className="flex items-center gap-2">
        ...
        {relatedGuides.length > 0 && (
          <section className="py-16 border-t border-border/30">
            <div className="container mx-auto px-4 md:px-6">
              <SectionHeading
                title="Plus de Guides Culturels"
                subtitle="Continuez à explorer la scène culturelle genevoise."
              />
        ...
        <CTASection
          ...
          subtitle="Rejoignez KulturTonight et recevez notre guide culturel genevois chaque jeudi — les meilleurs événements, articles et billets de dernière minute."
