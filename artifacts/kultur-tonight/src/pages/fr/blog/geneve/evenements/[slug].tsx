...
export default function FrBlogGenevaEvenementsDetailPage() {
      ...
      <>
        ...
        <main className="pt-32 min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/fr/blog/geneve/evenements" className="text-primary hover:underline">Retour aux Articles Événements</Link>
          </div>
        </main>
        <Footer />
      </>
  ...
  useSEO({
    ...
    canonical: `https://kulturtonight.com/fr/blog/geneve/evenements/${guide.slug}`,
    alternates: buildAlternatesFr(`/fr/blog/geneve/evenements/${guide.slug}`),
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 md:px-6 py-8">
          <Breadcrumbs
            items={[
              ...
              { label: "Articles Événements", href: "/fr/blog/geneve/evenements" },
              { label: guide.title },
            ]}
          />
        </div>
        <article className="py-12 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto">
              <div className="mb-4"><Badge variant="outline" className="bg-transparent text-primary border-primary/30 uppercase tracking-widest text-[10px] font-sans rounded-none">Article Événement</Badge></div>
              ...
              <div className="mt-12 pt-8 border-t border-border/30 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                ...
                <Link href="/fr/blog/geneve/evenements" className="text-sm text-primary hover:underline underline-offset-4">← Retour aux Articles Événements</Link>
              </div>
            </div>
          </div>
        </article>
        {related.length > 0 && (
          <section className="py-16 border-t border-border/30">
            <div className="container mx-auto px-4 md:px-6">
              <SectionHeading title="Plus d'Articles" subtitle="Continuez à explorer la scène culturelle genevoise." />
        ...
        <CTASection
          ...
          subtitle="Abonnez-vous et recevez notre guide culturel genevois chaque jeudi."
