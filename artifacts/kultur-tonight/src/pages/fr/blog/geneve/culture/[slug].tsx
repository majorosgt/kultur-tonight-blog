...
export default function FrBlogGenevaCultureDetailPage() {
      ...
      <>
        ...
        <main className="pt-32 min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/fr/blog/geneve/culture" className="text-primary hover:underline">Retour à Culture & Contexte</Link>
          </div>
        </main>
        <Footer />
      </>
  ...
  useSEO({
    ...
    canonical: `https://kulturtonight.com/fr/blog/geneve/culture/${guide.slug}`,
    alternates: buildAlternatesFr(`/fr/blog/geneve/culture/${guide.slug}`),
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 md:px-6 py-8">
          <Breadcrumbs
            items={[
              ...
              { label: "Culture & Contexte", href: "/fr/blog/geneve/culture" },
              { label: guide.title },
            ]}
          />
        </div>
        <article className="py-12 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto">
              <div className="mb-4"><Badge variant="outline" className="bg-transparent text-primary border-primary/30 uppercase tracking-widest text-[10px] font-sans rounded-none">Culture & Contexte</Badge></div>
              ...
              <div className="mt-12 pt-8 border-t border-border/30 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                ...
                <Link href="/fr/blog/geneve/culture" className="text-sm text-primary hover:underline underline-offset-4">← Retour à Culture & Contexte</Link>
              </div>
            </div>
          </div>
        </article>
        {related.length > 0 && (
          <section className="py-16 border-t border-border/30">
            <div className="container mx-auto px-4 md:px-6">
              <SectionHeading title="Plus d'Essais" subtitle="Continuez à explorer la scène culturelle genevoise." />
