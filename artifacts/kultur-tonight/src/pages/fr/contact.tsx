...
export default function FrContactPage() {
  useSEO({
    title: "Contact KulturTonight — Nous contacter",
    description: "Contactez l'équipe KulturTonight — la plateforme de découverte culturelle à Genève pour l'opéra, le théâtre, le jazz et la musique classique.",
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-2xl">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground font-serif leading-relaxed mb-10">
              Questions, partenariats ou soumissions éditoriales — nous serions ravis de vous entendre.
            </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-widest font-sans text-muted-foreground/60 mb-1">
                    Éditorial & Partenariats
                  </p>
                  <p className="text-foreground/70 font-sans text-sm leading-relaxed">
                    Notre formulaire de contact arrive bientôt. Pour toute demande urgente, contactez-nous via nos réseaux sociaux.
                  </p>
                </div>
              </div>
            </div>
