...
const categories = [
  ...
  { label: "Ce Week-end",  href: "/fr/geneve/que-faire-ce-weekend", active: true },
    ...
    <>
      ...
      <main className="pt-24">
        ...
        <CTASection
          ...
          subtitle="Rejoignez l'accès anticipé KulturTonight et recevez les alertes billets de dernière minute pour les meilleurs spectacles genevois."
