...
export default function BlogGenevaVenuesDetailPage() {
      ...
      <>
        ...
        <main className="pt-32 min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/en/blog/geneva/venues" className="text-primary hover:underline">Back to Venue Spotlights</Link>
          </div>
        </main>
        <Footer />
      </>
  ...
  useSEO({
    ...
    canonical: `https://kulturtonight.com/en/blog/geneva/venues/${guide.slug}`,
        ...
        <article className="py-12 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto">
              <div className="mb-4">
                <Badge variant="outline" className="bg-transparent text-primary border-primary/30 uppercase tracking-widest text-[10px] font-sans rounded-none">Venue Spotlight</Badge>
              </div>
              ...
              <div className="mt-12 pt-8 border-t border-border/30 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                ...
                <Link href="/en/blog/geneva/venues" className="text-sm text-primary hover:underline underline-offset-4">← Back to Venue Spotlights</Link>
              </div>
            </div>
          </div>
        </article>
