...
export default function BlogGenevaEventArticleDetailPage() {
      ...
      <>
        ...
        <main className="pt-32 min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/en/blog/geneva/events" className="text-primary hover:underline">Back to Event Features</Link>
          </div>
        </main>
        <Footer />
      </>
  ...
  useSEO({
    ...
    canonical: `https://kulturtonight.com/en/blog/geneva/events/${guide.slug}`,
        ...
        <div className="container mx-auto px-4 md:px-6 py-8">
          <Breadcrumbs
            items={[
              ...
              { label: "Event Features", href: "/en/blog/geneva/events" },
              { label: guide.title },
            ]}
          />
        </div>
        <article className="py-12 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto">
              <div className="mb-4"><Badge variant="outline" className="bg-transparent text-primary border-primary/30 uppercase tracking-widest text-[10px] font-sans rounded-none">Event Feature</Badge></div>
              ...
              <div className="mt-12 pt-8 border-t border-border/30 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                ...
                <Link href="/en/blog/geneva/events" className="text-sm text-primary hover:underline underline-offset-4">← Back to Event Features</Link>
              </div>
            </div>
          </div>
        </article>
