...
export default function BlogGenevaGuidesDetailPage() {
  const { slug } = useParams<{ slug: string }>();
  const guide = blogGuides.find((g) => g.slug === slug);
      ...
      <>
        ...
        <main className="pt-32 min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/en/blog/geneva/guides" className="text-primary hover:underline">
              Back to Guides
            </Link>
          </div>
        </main>
  ...
  const enToFrSlug: Record<string, string> = {
    ...
    "best-opera-in-geneva": "meilleur-opera-geneve",
    "best-live-music-venues-geneva": "meilleures-salles-musique-live-geneve",
    "family-cultural-events-geneva": "sorties-culturelles-famille-geneve",
  };
      ...
      <main className="pt-24">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap gap-6 mb-12 text-sm text-muted-foreground font-sans">
                <span className="flex items-center gap-2">
                  ...
                  {new Date(guide.date).toLocaleDateString("en-GB", { year: "numeric", month: "long", day: "numeric" })}
                </span>
                <span className="flex items-center gap-2">
              ...
              <div className="pt-8 border-t border-border/30 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                ...
                <Link href="/en/blog/geneva/guides" className="text-sm text-primary hover:underline underline-offset-4">
                  ← Back to Guides
                </Link>
              </div>
            </div>
        ...
        {related.length > 0 && (
          <section className="py-16 border-t border-border/30">
            <div className="container mx-auto px-4 md:px-6">
              <SectionHeading title="More Cultural Guides" subtitle="Continue exploring Geneva's cultural landscape." />
